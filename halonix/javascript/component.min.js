...
this.stage.append(this.contactTitle);this.content1=$("<div class='content content1'></div>");this.stage.append(this.content1);this.content1.append(this.author);this.content1.append(this.address);this.content1.append(this.email);this.content1.append(this.website);this.content1.append(this.mobile);this.content2=$("<div class='content content2 stage'></div>");this.swiper=$("<div class='swiper'></div>");this.progress=$("<div class='progress'></div>");this.progressBar=$("<div class='progressBar'></div>");
this.progress.append(this.progressBar);this.content2.append(this.progress);this.stage.append(this.content2);this.content2.append(this.swiper);bookConfig.CompanyLogoFile&&this.swiper.append(this.logo);this.swiper.append(this.description);this.content2.scroll({},Direction.top,"win10");this._super()},bookReadTimesVisible:function(){var a=setInterval(function(){try{this.ReadTimes=global.aboutReadTimes?global.aboutReadTimes:0,0<this.ReadTimes?(this.content1.css("height","235px"),this.content1.append(this.views),
clearInterval(a)):10<this.elements.iRead&&clearInterval(a)}catch(b){}}.bind(this),1E3)},showContact:function(){this.descriptionTitle.removeClass("focus");this.contactTitle.addClass("focus");this.descriptionTitle.css("border","1px solid transparent");this.contactTitle.css("border","1px solid "+this.fontColor);this.content1.show();this.content2.hide()},showDescription:function(){this.contactTitle.removeClass("focus");this.descriptionTitle.addClass("focus");this.contactTitle.css("border","1px solid transparent");
this.descriptionTitle.css("border","1px solid "+this.fontColor);this.content2.show();this.content2.refreshData();this.content1.hide()},onShow:function(){this._super();bookConfig.CompanyLogoFile||bookConfig.AboutDescription?this.showDescription():this.showContact();this.content2.refreshData()}}).extend(PcAboutFrame);var PcBookmarkItem=Class({create:function(a,b){this.mainColor=bookConfig.formBackgroundColor?bookConfig.formBackgroundColor:bookConfig.toolbarColor;this.fontColor=bookConfig.formFontColor?bookConfig.formFontColor:bookConfig.iconColor;a.fontColor=this.fontColor;this._super(a,b)}}).extend(BookmarkItem);var PcBookmarkListPanel=Class({create:function(a){this.mainColor=bookConfig.formBackgroundColor?bookConfig.formBackgroundColor:bookConfig.toolbarColor;this.fontColor=bookConfig.formFontColor?bookConfig.formFontColor:bookConfig.iconColor;this.mainColorObj=Color(this.mainColor);this.fontColorObj=Color(this.fontColor);this._super(a)},onCreate:function(){},newItem:function(a){return new PcBookmarkItem(a,this.callback)}}).extend(BookmarkListPanel);var PcBookmarkForm=Class({create:function(a){this._super(a)},onCreate:function(){this._super()},initHtml:function(){this.stage.addClass("win10_border");this.stage.append(this.title);this.favicon&&(bookConfig.RightToLeft?this.title.append(this.favicon):this.title.prepend(this.favicon));this.stage.append(this.close);this.content=$("<div class='bookmark_content'></div>");this.stage.append(this.content);var a=$("<p class='inputForm'></p>");a.append(this.input);a.append(this.colorSelection);this.content.append(a);
this.content.append(this.leftAddPage);this.content.append(this.rightAddPage);this.content.append(this.bookmarkListTitle);this.content.append(this.bookmarkListPanel.bookmarkSwiper);this.content.append(this.remove);this.parent.append(this.stage);this.refreshPanel()}}).extend(PcBookmarkFrame);var PcHelpForm=Class({create:function(a){this._super(a)},onCreate:function(){this._super()},initHtml:function(){this.stage.addClass("win10_border");this.stage.append(this.title);this.favicon&&(bookConfig.RightToLeft?this.title.append(this.favicon):this.title.prepend(this.favicon));this.stage.append(this.close);this.stage.append(this.image);this.title1&&this.stage.append(this.title1);this.title2&&this.stage.append(this.title2);this._super()}}).extend(PcHelpFrame);var PcPrintForm=Class({create:function(a){this._super(a)},onCreate:function(){this._super()},initHtml:function(){this.stage.addClass("win10_border");this.stage.append(this.title);this.favicon&&(bookConfig.RightToLeft?this.title.append(this.favicon):this.title.prepend(this.favicon));this.stage.append(this.close);this.appendPrintOptions();this._super()}}).extend(PcPrintFrame);var PcTableOfContentItem=Class({create:function(a,b,c){b.fontColor=bookConfig.formFontColor?bookConfig.formFontColor:bookConfig.iconColor;this._super(a,b,c)}}).extend(TableOfContentItem);var PcTableOfContentForm=Class({nailUpIcon:null,nailUpStatus:!0,create:function(a){this._super(a);this.nailUpIcon=$("<img alt='nail up' width='auto' height='auto' class='nailUp nailUpActive' src='"+(form_icons.nailUp?"data:image/png;base64,"+form_icons.nailUp:uiBaseURL+"nailUp.png")+"'/>");this.stage.append(this.nailUpIcon);this.nailUpIcon.bind("click",function(){this.nailUpIcon.toggleClass("nailUpActive");this.nailUpStatus=!this.nailUpStatus;var b=$(".tableofcontent_form").outerWidth(!0),c=parseInt(_get(global,
"staticAd.adPosition",1));this.nailUpStatus?(bookConfig.leftMargin+=b+10,window.staticAd&&window.staticAd.haveAd&&0<window.staticAd.data.length&&[1,2].includes(c)&&$("#slide-show").css({width:"calc(100% - 10px - "+b+"px)",right:"0px"})):(bookConfig.leftMargin-=b+10,window.staticAd&&window.staticAd.haveAd&&0<window.staticAd.data.length&&[1,2].includes(c)&&$("#slide-show").css({width:"100%",right:"0px"}));onStageResize()}.bind(this))},onResize:function(){var a=Math.max(windowHeight-bookConfig.topMargin-
bookConfig.bottomMargin-toolBar.getHeight(),1);toolBar.getWidth();var b=toolBar.getTopHeight()+10;this.width=250;this.height=a-40;this.maxHeight=this.height-75;this.stage.css({height:this.height+"px",top:b+"px"});this.tableofcontentSwiper.css("height",this.maxHeight+"px");this.elements.refresh()},show:function(){this.visible=!0;this.stage.animate({left:10},400,function(){this.setA11yAndFocus()}.bind(this));this.onShow();if(this.nailUpStatus){var a=$(".tableofcontent_form").outerWidth(!0);bookConfig.leftMargin+=
a+10;onStageResize();var b=parseInt(_get(global,"staticAd.adPosition",1));window.staticAd&&window.staticAd.haveAd&&0<window.staticAd.data.length&&[1,2].includes(b)&&$("#slide-show").css({width:"calc(100% - 10px - "+a+"px)",right:"0px"})}},hide:function(){this.visible=!1;this.stage.animate({left:2*-this.width},400,function(){this.onHide()}.bind(this));if(this.nailUpStatus){var a=$(".tableofcontent_form").outerWidth(!0);bookConfig.leftMargin-=a+10;onStageResize();a=parseInt(_get(global,"staticAd.adPosition",
1));window.staticAd&&window.staticAd.haveAd&&0<window.staticAd.data.length&&[1,2].includes(a)&&$("#slide-show").css({width:"100%",right:"0px"})}}}).extend(PcTableOfContentFrame);var PcVideoGalleryForm=Class({create:function(a){this._super(a)},initHtml:function(){this.stage.addClass("win10_border");this.stage.append(this.title);this.favicon&&(bookConfig.RightToLeft?this.title.append(this.favicon):this.title.prepend(this.favicon));this.stage.append(this.close);this.stage.append(this.video);this.stage.append(this.info);if(this.videoList&&1<this.videoList.length){var a=$("<div class='video_list'></div>");a.append(this.videoListTitle);a.append(this.videoSwiper);this.stage.append(a)}else this.stage.css("width",
"335px");this._super()}}).extend(PcVideoGalleryFrame);var PcShareForm=Class({create:function(a){this._super(a)},onCreate:function(){this._super()},initHtml:function(){var a=this;this.stage.addClass("win10_border");this.stage.append(this.title);this.favicon&&(bookConfig.RightToLeft?this.title.append(this.favicon):this.title.prepend(this.favicon));this.stage.append(this.close);this.content=$("<div class='share_content'></div>");this.initSwiper();this.stage.append(this.content);this.shareCurrentPageBox.append(this.shareCurrentCheck).append(this.shareCurrentPageTitle1);
